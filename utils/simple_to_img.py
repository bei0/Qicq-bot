...
def create_img(text, width=700, font_size=30, offset_x=50, offset_y=50):
    ...
    font = ImageFont.truetype(os.path.join(Config.BasePath, "static/fonts/sarasa-mono-sc-regular.ttf"), font_size)
    lines = text.split('\n')
